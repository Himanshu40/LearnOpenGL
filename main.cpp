...
int main() {
	...
	// Check if vertex shader compilation is successful or not?
	int  success;
	char infoLog[512];
	...
	// Check if fragment shader compilation is successful or not?
	...
	// Check if linking all the above shader failed or successful
